        ...
        <div>
            ...
            <div class="divHorario">
                <div class="row">
                    <div class="col-sm">
                        <p>
                        <a className="btn btn-outline-secondary btn-lg btn-block" href="http://google.com"> Ver</a>
                        </p>
                    </div>
                    <div class="col-sm">
                        <p>
                        <a className="btn btn-outline-dark btn-lg btn-block" href="http://google.com"> Descargar</a>
                        </p>
                    </div>
                </div>
            </div>
